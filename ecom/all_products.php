...
<head>
    ...
    <!-- Customizable CSS -->
    <link rel="stylesheet" href="u_assets/css/main.css">
    <link rel="stylesheet" href="u_assets/css/blue.css">
    <link rel="stylesheet" href="u_assets/css/owl.carousel.css">
    <link rel="stylesheet" href="u_assets/css/owl.transitions.css">
    <link rel="stylesheet" href="u_assets/css/animate.min.css">
    <link rel="stylesheet" href="u_assets/css/rateit.css">
    <link rel="stylesheet" href="u_assets/css/bootstrap-select.min.css">

    <!-- Icons/Glyphs -->
    <link rel="stylesheet" href="u_assets/css/font-awesome.css">
...
<body class="cnt-home">
                            ...
                            <div class="nav-outer">
                                <ul class="nav navbar-nav">
                                    <li class="active dropdown yamm-fw"> <a href="home.html" data-hover="dropdown"
                                            class="dropdown-toggle" data-toggle="dropdown">Home1234</a> </li>
                                    <?php 
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
                                                            ...
                                                            <ul class="links">
                                                                ...
                                                                $br = explode(',',$result['sub_cat_id']);
                                                                for($i=0;$i<count($ar);$i=$i+1){
                                                                    
                                                                
                                                                
                                                                ?>
                                                                <li><a href="all_products.php?id=<?= $br[$i]; ?>" target="_blank"><?php echo $ar[$i]; ?></a></li>
                                                                <?php 
                                                                    }
                                                                ?>
                                                            </ul>
                                ...
                                <div class="product-slider">
                                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                        <?php 
                                            ...
                                            while($result = mysqli_fetch_assoc($query_fetch_prod)){
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="detail.php?id=<?= $result['id']; ?>"><img
                                                                    src="<?php echo $result['image'];?>" alt=""></a>
                                                        </div>
                                                        <!-- /.image -->
                                                    ...
                                                    <div class="product-info text-left">
                                                        <h3 class="name"><a target="_blank" href="detail.php?id=<?= $result['id']; ?>"><?php echo  $result['name'];?></a>
                                                        </h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="description"></div>
                                                        <div class="product-price"> <span class="price"> <?php echo $result['discount_price'];?> </span>
                                                            <span class="price-before-discount">$ <?php echo $result['price'];?></span>
                                                        </div>
                                                        <!-- /.product-price -->
    ...
    <script src="u_assets/js/jquery-1.11.1.min.js"></script>
    <script src="u_assets/js/bootstrap.min.js"></script>
    <script src="u_assets/js/bootstrap-hover-dropdown.min.js"></script>
    <script src="u_assets/js/owl.carousel.min.js"></script>
    <script src="u_assets/js/echo.min.js"></script>
    <script src="u_assets/js/jquery.easing-1.3.min.js"></script>
    <script src="u_assets/js/bootstrap-slider.min.js"></script>
    <script src="u_assets/js/jquery.rateit.min.js"></script>
    <script type="text/javascript" src="u_assets/js/lightbox.min.js"></script>
